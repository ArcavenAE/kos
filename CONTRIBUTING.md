...
```bash
git clone https://github.com/ArcavenAE/kos.git
cd kos
just build    # Build
just test     # Run tests
...
Open a [Bug Report](https://github.com/ArcavenAE/kos/issues/new?template=bug-report.yml) and include:
...
Open a [Feature Request](https://github.com/ArcavenAE/kos/issues/new?template=feature-request.yml).
